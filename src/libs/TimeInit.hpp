...
#ifndef TIMEINIT_H   // Include this "block" only if TIME_H is NOT defined
#define TIMEINIT_H   // Upon the first inclusion, define TIME_H so that
...
public:
	...
	TimeInit(int h = 0, int m = 0, int s = 0); // Constructor with default values
